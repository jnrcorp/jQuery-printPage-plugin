 ...
 * @licence: MIT
 * @desciption: jQuery page print plugin help you print your page in a better
 *              way
 */
...
(function($) {
  $.fn.printPage = function(options) {
		 ...
		 * 
		 * @param {jQuery}
		 *            el - The button calling the plugin
		 * @param {Object}
		 *            pluginOptions - options for this print button
		 */
		...
		/**
		 * Inject iframe into document and attempt to hide, it, can't use
		 * display:none You can't print if the element is not dsplayed
		 * 
		 * @param {jQuery}
		 *            el - The button calling the plugin
		 * @param {Object}
		...
		function addIframeToPage(el, pluginOptions) {
			...
			var url = (pluginOptions.url) ? pluginOptions.url : $(el).attr(pluginOptions.attr),
					urlParams = (pluginOptions.paramForm) ? "?"+pluginOptions.paramForm.serialize() : "";
		...
		/*
		 * Build html compononents for this plugin
		 */
		var components = {
			iframe : function(url) {
